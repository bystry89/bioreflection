...
Having selected the 7 items, we collected data on the respective factual beliefs of the expert community by soliciting responses from `r length(unique(ex$ResponseId))` leading bioethicists.
